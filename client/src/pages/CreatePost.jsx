    ...
    <section className="max-w-7xl mx-auto ">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[16px] max-w-[500px]">
          Create imaginative and visually stunnig images through DALL-E AI and
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        <div className="flex flex-col gap-5">
          ...
          <FormField
            ...
            type="text"
            name="prompt"
            placeholder="A white dinasour with 3 legs"
            value={form.prompt}
            handleChange={handleChange}
            isSurpriseMe
        ...
        <div className="mt-5 flex gap-5">
              ...
              w-full text-sm sm:w-auto px-5 py-2.5 text-center'
              >{generatingImg ? 'Generating...' : 'Generate'}</button>
        </div>
        <div className="mt-10">
              <p className="mt-2 text-[#666E75] text-[14px]">Once you have created the images 
              you want to share it with others in the community.</p>
              <button 
              type="submit"
